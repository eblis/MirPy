...
#ifndef M_MIRPY_VERSION_H
#define M_MIRPY_VERSION_H
...
#define __DESC                  "Allows you to create python scripts to run in miranda that can take advantage of miranda's services and events."
...
#define __PLUGIN_DISPLAY_NAME   "MirPy Scripting Plugin"

#endif //M_MIRPY_VERSION_H
